...
function showStep(step) {
  const calculatorStep = $('calculatorStep');
  const contactStep = $('contactStep');
  calculatorStep.classList.toggle('active', step === 'calculator');
  contactStep.classList.toggle('active', step === 'contact');
...
$('editButton').addEventListener('click', () => showStep('calculator'));
